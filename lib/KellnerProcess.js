...
const {
	kellnerEventbus,
	kellnerJobbus: kellnerWorkerbus,
	kellnerCommandbus,
...
class KellnerProcess {
	constructor(name) {
		...
		this[kellnerWorkerbus] = new IoPort(this);
		...
		this.use(this[kellnerEventbus]).use(this[kellnerCommandbus]).use(this[kellnerNotificationbus]).use(this[kellnerWorkerbus]);
	}
